...
"border-radius:15px;")
        ...
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap(":/img/utils/images/sliderHandle.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap(":/img/utils/images/MusicListItem.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionSave_Selected_to_a_Playlist.setIcon(icon16)
        ...
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap(":/img/utils/images/dialog-music.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionSave_all_to_a_playlist.setIcon(icon17)
